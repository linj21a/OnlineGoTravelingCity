...
public class Route implements Serializable {
     ...
     */
    public Route(){}
    public Route(int rid, String rname, double price, String routeIntroduce, String rflag, String rdate, String isThemeTour, int count,
                 int cid, String rimage, int sid, String sourceId, Category category, Seller seller, List<RouteImage> routeImgList) {
        this.rid = rid;
        this.rname = rname;
        this.price = price;
